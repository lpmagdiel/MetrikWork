export const plans = [
  ...
  },
  {
    ...
    features: ["Hasta 15 miembros","Mensajes en el chat ilimitados", "Informes avanzados","Imagenes con alta calidad"],
    color: "#000000",
    gradient: "linear-gradient(135deg, #000000, #a7f3d0)",
    icon: 2,
    recommended: false,
  ...
  },
  {
    ...
    features: ["Miembros ilimitados", "Imagenes con máxima calidad", "Todo incluido"],
    color: "#000000",
    gradient: "linear-gradient(135deg, #000000, #a7f3d0)",
    icon: 3,
    recommended: false,
